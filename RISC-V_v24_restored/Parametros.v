...
Carolina Estrella Machado					- 18/0074792
...
Matheus Guaraci Lima Bouças Alves		- 18/0046951
André Cássio Barros de Souza				- 16/0111943
Marco Antônio Souza de Athayde			- 18/0126814
Thiago Pereira Ribeiro Dantas				- 14/0170961



 Adaptado para a placa de desenvolvimento DE1-SoC.
 Prof. Marcus Vinicius Lamar   2022/2
...
// *********************************************************** 
// * Escolha a organizacao do processador a ser implementado *
`define UNICICLO
//`define MULTICICLO 
//`define PIPELINE
...
// ************************************************
// * Colocar o CPU.v como top level e descomentar *
//`define SO_CPU
...
// Ver pag. 120 do Guia Prático, RARS14_Custom 4 RV32IMFD 0x40001128
`ifdef RV32I
	MISA = 32'b01_0000_00_0000_0000_0000_0001_0000_0000, // 0x40000100
`elsif RV32IM
	MISA = 32'b01_0000_00_0000_0000_0001_0001_0000_0000, // 0x40001100
`elsif RV32IMF
	MISA = 32'b01_0000_00_0000_0000_0001_0001_0010_0000, // 0x40001120
`else
	MISA = 32'b00_0000_00000000000000000000000000,
`endif
...
// Adicionando um bit a mais em cada registrador intermediário para o sinal "ActualInstruction", para
// contagem de instruções no banco de registradores CS.
...
`ifndef RV32IMF
	NIFID  = 97,
	NIDEX  = 283+6, // adicionardo 32 CSreg Write, 1 ecall , 1 invIntrc, 1 CSRegWrite , 2 expadir orig(a\b)ALU, 1 expandir men2reg
	NEXMEM = 233+6,
	NMEMWB = 288+6,
`else
	NIFID  = 97,
